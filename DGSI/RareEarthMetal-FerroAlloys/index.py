...
for file_info in files:
    try:
        ...
        df['Mineral'] = 'RareEarthMetal-FerroAlloys'      # <--- Change name
        df['HS_Code'] = '72029921'    # <--- Change HS Code
        df['Flow'] = 'Import'
...
if combined_data:
    ...
    master_df.to_csv('RareEarthMetal-FerroAlloys_master_data.csv', index=False)
    print("\nSUCCESS! Saved 'RareEarthMetal-FerroAlloys_master_data.csv'")
