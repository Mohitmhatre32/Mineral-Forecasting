...
for file_info in files:
    try:
        ...
        df['Mineral'] = 'Graphite-ArtificialGraphite'      # <--- Change name
        df['HS_Code'] = '38011000'    # <--- Change HS Code
        df['Flow'] = 'Import'
...
if combined_data:
    ...
    master_df.to_csv('Graphite-ArtificialGraphite_master_data.csv', index=False)
    print("\nSUCCESS! Saved 'Graphite-ArtificialGraphite_master_data.csv'")
