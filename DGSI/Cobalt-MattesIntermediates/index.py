...
for file_info in files:
    try:
        ...
        df['Mineral'] = 'Cobalt-MattesIntermediates'      # <--- Change name
        df['HS_Code'] = '75011000'    # <--- Change HS Code
        df['Flow'] = 'Import'
...
if combined_data:
    ...
    master_df.to_csv('Cobalt-MattesIntermediates_master_data.csv', index=False)
    print("\nSUCCESS! Saved 'Cobalt-MattesIntermediates_master_data.csv'")
