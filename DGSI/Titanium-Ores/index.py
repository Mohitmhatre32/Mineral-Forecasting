...
for file_info in files:
    try:
        ...
        df['Mineral'] = 'Titanium-Ores'      # <--- Change name
        df['HS_Code'] = '26140010'    # <--- Change HS Code
        df['Flow'] = 'Import'
...
if combined_data:
    ...
    master_df.to_csv('Titanium-Ores_master_data.csv', index=False)
    print("\nSUCCESS! Saved 'Titanium-Ores_master_data.csv'")
