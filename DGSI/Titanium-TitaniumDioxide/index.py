...
for file_info in files:
    try:
        ...
        df['Mineral'] = 'Titanium-TitaniumDioxide'      # <--- Change name
        df['HS_Code'] = '28230010'    # <--- Change HS Code
        df['Flow'] = 'Import'
...
if combined_data:
    ...
    master_df.to_csv('Titanium-TitaniumDioxide_master_data.csv', index=False)
    print("\nSUCCESS! Saved 'Titanium-TitaniumDioxide_master_data.csv'")
