...
for file_info in files:
    try:
        ...
        df['Mineral'] = 'Titanium-UnwroughtMetalPowders'      # <--- Change name
        df['HS_Code'] = '81082000'    # <--- Change HS Code
        df['Flow'] = 'Import'
...
if combined_data:
    ...
    master_df.to_csv('Titanium-UnwroughtMetalPowders_master_data.csv', index=False)
    print("\nSUCCESS! Saved 'Titanium-UnwroughtMetalPowders_master_data.csv'")
