...
for file_info in files:
    try:
        ...
        df['Mineral'] = 'LithiumCarbonate'      # <--- Change name
        df['HS_Code'] = '28369100'    # <--- Change HS Code
        df['Flow'] = 'Import'
...
if combined_data:
    ...
    master_df.to_csv('LithiumCarbonate_master_data.csv', index=False)
    print("\nSUCCESS! Saved 'LithiumCarbonate_master_data.csv'")
