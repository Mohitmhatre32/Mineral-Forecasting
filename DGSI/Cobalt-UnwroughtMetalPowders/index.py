...
for file_info in files:
    try:
        ...
        df['Mineral'] = 'Cobalt-UnwroughtMetalPowders'      # <--- Change name
        df['HS_Code'] = '81052010'    # <--- Change HS Code
        df['Flow'] = 'Import'
...
if combined_data:
    ...
    master_df.to_csv('copper_master_data.csv', index=False)
    print("\nSUCCESS! Saved 'lithium_master_data.csv'")
