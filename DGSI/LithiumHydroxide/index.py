...
for file_info in files:
    try:
        ...
        df['Mineral'] = 'LithiumHydroxide'      # <--- Change name
        df['HS_Code'] = '28252000'    # <--- Change HS Code
        df['Flow'] = 'Import'
...
if combined_data:
    ...
    master_df.to_csv('LithiumHydroxide_master_data.csv', index=False)
    print("\nSUCCESS! Saved 'LithiumHydroxide_master_data.csv'")
