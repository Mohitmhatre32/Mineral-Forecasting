...
for file_info in files:
    try:
        ...
        df['Mineral'] = 'Graphite-NaturalGraphite'      # <--- Change name
        df['HS_Code'] = '25041010'    # <--- Change HS Code
        df['Flow'] = 'Import'
...
if combined_data:
    ...
    master_df.to_csv('Graphite-NaturalGraphite_master_data.csv', index=False)
    print("\nSUCCESS! Saved 'Graphite-NaturalGraphite_master_data.csv'")
